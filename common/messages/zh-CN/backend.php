...
return [
    ...
    'Description' => '描述',
     'Church name'=>'教会名称',
     'Church pastor'=>'教会牧师',
     'church contact info'=>'教会联系方式',
     'Church renshu'=>'教会人数',
     'Church vision'=>'教会异象',
     'Church service time'=>'教会礼拜时间',
     'Church mission'=>'教会使命',
     'church address'=>'教会地址',
     'University'=>'大学',
     'Disc type'=>'信徒类型',
     ...
     'Work Place'=>'工作地方',
     'Tribe'=>'民族',
     'Disc Jiedai Yuanyin'=>'信徒接待原因',
     'Phone'=>'手机号码',
     'Acceptance Date'=>'接待日志',
     'Age'=>'年龄',
     'Disc jieshaoren'=>'信徒介绍人',
     'Full Name'=>'全名',
     'Department'=>'部门',
     'Expert Category'=>'专门别',
     'Awards'=>'奖品',
